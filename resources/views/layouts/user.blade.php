...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a class="logo">
      ...
      <span class="logo-mini"><img src="/storage/images/sccv.jpg" class="img-circle" id="logo" height="50" width="50"></span>
      <!-- logo for regular state and mobile devices -->

      <span class="logo-lg">    <img src="/storage/images/sccv.jpg" class="img-circle" id="logo" height="50" width="70"></span>
    </a>
