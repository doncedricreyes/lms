...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a class="logo">
      ...
      <span class="logo-mini"><img src="/storage/images/sccv.jpg" class="img-circle" id="logo" height="45" width="50"></span>
      <!-- logo for regular state and mobile devices -->

      <span class="logo-lg">    <img src="/storage/images/sccv.jpg" class="img-circle" id="logo" height="45" width="50"></span>
    </a>
