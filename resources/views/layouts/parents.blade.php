  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li><a href="/parent/classes"><i class="fa fa-graduation-cap"></i> <span>Class</span></a></li>
  ...
  <aside class="control-sidebar control-sidebar-dark">
    ...
    <div class="tab-content">
      ...
      <div class="tab-pane active" id="control-sidebar-home-tab">
        <a href='parent/logout'><h3 class="control-sidebar-heading">Settings</h3></a>
        <a href='/parent/logout'><h3 class="control-sidebar-heading">Logout</h3></a>
