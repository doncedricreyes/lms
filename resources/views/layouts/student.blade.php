        ...
        <ul class="nav navbar-nav">
          ...
          <li class="dropdown user user-menu">
            ...
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              ...
              <img src="/storage/images/{{$profiles->get(0)->profile_pic}}" class="user-image" alt="User Image">
            ...
            <ul class="dropdown-menu">
              ...
              <li class="user-footer">
                <div class="pull-left">
                  <a href="/student/profile/{{Auth::user()->id}}" class="btn btn-default btn-flat">Profile</a>
                </div>
  ...
  <aside class="control-sidebar control-sidebar-dark">
    ...
    <div class="tab-content">
      ...
      <div class="tab-pane active" id="control-sidebar-home-tab">
        <a href='student/logout'><h3 class="control-sidebar-heading">Settings</h3></a>
        <a href='/student/logout'><h3 class="control-sidebar-heading">Logout</h3></a>
