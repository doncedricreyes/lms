        ...
        <nav class="navbar-inverse">
                <div class="container">
                  <div class="navbar-text">
                        <a href="index.html" class="navbar-left"><img src="/storage/images/logo3.png" height="70" width="70">SCCV-<span>LMS</span></a>
                  </div>
                </div>
              </nav>
              ...
              @endif
                ...
                <h4><mark> LOGIN AS PARENT</mark></h4></p>
    ...
    <span class="glyphicon glyphicon-envelope form-control-feedback"></span>
        ...
        <!--diretso login na button dito--> <li role="presentation"><a href="/teacher/login"> <span class="glyphicon glyphicon-user" aria-hidden="true"></span>Teacher</a></li>
                ...
                <div class="container" style="background-color:#f1f1f1">
                  ...
                  <span class="psw"><a href="{{ route('parent.password.request') }}">Forgot password? </a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
