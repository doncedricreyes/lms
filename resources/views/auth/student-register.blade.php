...
<div class="social-auth-links text-center">
  <p>- OR -</p>
  <a href="/parent/register" class="btn btn-block btn-social  btn-flat"><i class="fa fa-user-plus"></i> Register as parent
    </a>
</div>
<!-- /.social-auth-links -->

<a href="/student/login" class="text-center">Already a member?</a>
@endsection