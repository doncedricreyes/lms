...
<body>
        ...
        <nav class="navbar-inverse">
              ...
              @endif
                ...
                <h4><mark> LOGIN AS ADMIN</mark></h4></p>
                <form method="POST" action="{{ route('admin.login.submit') }}">
                  @csrf
                <div class="container">
               
                  <input id="email" placeholder="Enter Email" type="email" class="form-control{{ $errors->has('email') ? ' is-invalid' : '' }}" name="email" value="{{ old('email') }}" required autofocus><br>
    ...
    <span class="glyphicon glyphicon-envelope form-control-feedback"></span>
        ...
        <!--diretso login na button dito--> <li role="presentation"><a href="teacher/login"> <span class="glyphicon glyphicon-user" aria-hidden="true"></span>Teacher</a></li>
                ...
                <div class="container" style="background-color:#f1f1f1">
                  ...
                  <span class="psw"><a href="{{ route('admin.password.request') }}">Forgot password? </a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
