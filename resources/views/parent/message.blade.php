                            ...
                            <div class="box box-solid">
                              ...
                              <div class="box-body no-padding">
                                <ul class="nav nav-pills nav-stacked">
                                  ...
                                  <li  class="active"><a href="/parent/messages/{{Auth::user()->id}}/compose"><i class="fa fa-file-text-o"></i> Compose</a></li>
...
@if (\Route::current()->getName() == 'parent.message.student.index')
<form action = "{{route('parent.message.student.store', $students->get(0)->id)}}" method="post" enctype="multipart/form-data">
        {{csrf_field() }}
        <div class="box-body">
                <div class="form-group">
                  <input class="form-control" id="name" name="name" value="{{$students->get(0)->name}}" placeholder="To:" readonly>
