                ...
                <form action = "{{route('search_parent')}}" role="search" method="get"enctype="multipart/form-data">
                    ...
                    <tbody>
                            ...
                            <tr>
                                ...
                                <td><p data-placement="top" data-toggle="tooltip" title="Edit"><a href="/admin/parents/{{$row->id}}/edit"><button class="btn btn-primary btn-xs" data-title="Edit" data-toggle="modal" data-target="#edit" ><span class="glyphicon glyphicon-pencil"></span></button></a></p></td>
                    ...
                    <td><p data-placement="top"  data-toggle="tooltip" title="Message"><a href="/admin/parents/{{$row->id}}/message"><button class="btn btn-primary btn-xs" data-title="View"><i class="glyphicon glyphicon-comment">
                </tr>
                    @endforeach
