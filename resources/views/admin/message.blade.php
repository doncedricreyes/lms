...
@if (\Route::current()->getName() == 'admin.message.index')
<form action = "{{route('admin.message.store', $admins->get(0)->id)}}" method="post" enctype="multipart/form-data">
        {{csrf_field() }}
        <div class="box-body">
                <div class="form-group">
                  <input class="form-control" id="name" name="name" value="{{$admins->get(0)->name}}" placeholder="To:" readonly>
                </div>
