                                    ...
                                    <div class="box box-solid">
                                      ...
                                      <div class="box-body no-padding">
                                        <ul class="nav nav-pills nav-stacked">
                                          ...
                                          <li class="active"><a href="/teacher/messages/{{Auth::user()->id}}"><i class="fa fa-envelope-o"></i> Sent</a></li>
                                          <li><a href="/teacher/messages/{{Auth::user()->id}}/compose"><i class="fa fa-file-text-o"></i> Compose</a></li>
