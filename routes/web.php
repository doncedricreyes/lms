...
Route::put('/class/{id}/delete', 'AddClassController@destroy')->name('class.destroy');
...
Route::delete('/class/students/{id}/delete','AdminController@class_list_delete')->name('class_list.delete');
