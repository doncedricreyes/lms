...
class Class_StudentController extends Controller
{
    ...
    public function showclass(Request $request)
    {
        ...
        $class_subject_teachers = Class_Subject_Teacher::with('classes','subjects','teachers')->where('id',$class_student->class_subject_teacher_id)
             ->whereHas('classes', function ($q){
            $q->where('status', 'active');
        })->first();
    }
    ...
    public function exam($id)
    {
       $exams = Exam::with('class_subject_teachers')->where('id',$id)->get();
        ...
        return view('student.exam', compact('exams','quiz_attempt','quiz_latest','exam_grades'));
    }
